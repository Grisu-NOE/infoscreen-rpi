...
%		}
	...
	\item {Weiters erscheint ein Fenster mit Titel \begin{em}Welcome to Raspberry Pi\end{em} (siehe \reffig{rpiwiz1}).
		\begin{itemize}
...
%		\lstinline|setxkbmap de|\\
	...
	\item {Es wird ein Menü ähnlich wie in \reffig{menu} angezeigt, mit den Optionen zur weitern Einrichtung des Betriebsystems. 
...
\begin{itemize}
	...
	\item {Es wird das Installationsscript heruntergeladen und ausgeführt. Die Ausgabe sollte so ähnlich aussehen:
		\begin{lstlisting}
###############################################
Installations-Script         Version 2019-07-26
###############################################
...
- Paket "libjsoncpp1" wurde heruntergeladen.
- Paket "libjsoncpp1" wurde installiert.
- Paket "firefox-esr" wurde heruntergeladen.
- Paket "firefox-esr" wurde installiert.
