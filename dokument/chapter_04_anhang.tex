...
Die Datei \lstinline|/etc/xdg/lxsession/LXDE-pi/autostart| wurde wie folgt angepasst:\\
Original-Inhalt:
\begin{lstlisting}
...
\begin{itemize}
	...
	\item {\lstinline|user_pref("general.useragent.override", "Rpi-Infoscreen2.2");|\\
...
*/5  *	* * *	root	pidof midori > /dev/null && echo "`date` - midori running" > /root/running.log || (echo "`date` - midori not running" >> /root/reboot.log; reboot )
